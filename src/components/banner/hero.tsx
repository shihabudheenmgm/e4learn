    ...
    return (
        <>
            <section className={`position-relative overflow-hidden pt-5 pt-lg-3`}>
                <Bannerbg bgimage={BgImage.src} />
                <Container>
                    <Row className="align-items-center">
                        <Col lg={7}>
                            <div className="bannercontents">
                                <h1 className="display-6">
                                    Learn Real-World Skills from Top{" "}
                                ...
                                <h4 className="my-3 lead">Live, real-world, instructor-led courses built for students & professionals.</h4>
                                <p>AI-powered course journeys, live mentorship, and career-ready training - all in one place.</p>
                            </div>
                        </Col>
                        <Col lg={5}>
                            <SideBg />
                        ...
                        <Col>
                            <div className="search">
                                <div className="cta-buttons">
                                    ...
                                    <button type="button" className="orientation">
                                        Join Free Orientation
                                    </button>
                                    <button type="button" className="live-session">
                                        ▶ Join Free Live Session
                                    </button>
                                </div>

                                <div className="search-bar">
                                    <input type="text" placeholder="Search course by skill, domain, or outcome..." />
